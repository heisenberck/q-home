...
const App: React.FC = () => {
    ...
    useEffect(() => {
        // Force light mode and clean up any dark mode remnants
    ...
    if (loadingState === 'error') {
        return (
            <div className="flex h-screen w-screen flex-col items-center justify-center bg-red-50 p-8 text-center text-red-800">
