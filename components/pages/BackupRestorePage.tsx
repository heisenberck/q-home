    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
                <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-blue-600"><ArrowDownTrayIcon /> Backup Dữ liệu</h3>
                <p className="text-gray-600 mb-4 text-sm">Tạo một bản sao lưu toàn bộ dữ liệu của ứng dụng vào một file JSON. Lưu file này ở nơi an toàn.</p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
                <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-yellow-600"><ArrowUpTrayIcon /> Phục hồi (Restore)</h3>
                <p className="text-gray-600 mb-4 text-sm"><strong className="text-red-500">CẢNH BÁO:</strong> Thao tác này sẽ xóa toàn bộ dữ liệu hiện tại và thay thế bằng dữ liệu trong file backup.</p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
                <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-red-600"><TrashIcon /> Quản lý Dữ liệu Hệ thống</h3>
                <p className="text-gray-600 mb-6 text-sm">Các công cụ này dùng để khởi tạo lại hệ thống. Vui lòng cân nhắc kỹ trước khi sử dụng.</p>
            ...
            {confirmAction && (
                <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t-4 border-red-500 p-6 shadow-[0_-4px_20px_rgba(0,0,0,0.3)] animate-slide-up">
                    <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-6">
                        <div className="flex-shrink-0 bg-red-100 p-3 rounded-full"><WarningIcon className="h-8 w-8 text-red-600" /></div>
                        <div className="flex-grow text-center md:text-left">
                            <h4 className="text-lg font-bold text-red-600 mb-1">Xác nhận Thao tác Nguy hiểm</h4>
                            <p className="text-sm text-gray-700">{getConfirmMessage()}</p>
                        </div>
                        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                            <input type="password" value={password} onKeyDown={e => e.key === 'Enter' && handleConfirmAction()} onChange={e => setPassword(e.target.value)} placeholder="Mật khẩu Admin" className="p-2 border border-gray-300 rounded-md bg-white w-full sm:w-48 focus:ring-2 focus:ring-red-500 outline-none" autoFocus />
                            <div className="flex gap-2 w-full sm:w-auto">
                                ...
                                <button onClick={() => setConfirmAction(null)} className="flex-1 sm:flex-none px-4 py-2 bg-gray-200 text-gray-800 font-semibold rounded-md hover:bg-gray-300">Hủy</button>
                            </div>
                        </div>
                    </div>
                </div>
