...
const DataImportModal: React.FC<{
    ...
    const processExcelData = () => {
        ...
        const updates = preview.map(rowArray => {
            ...
            if (row.vehicles_bicycle) String(row.vehicles_bicycle).split(';').forEach(plate => { vehicles.push({ PlateNumber: plate.trim(), Type: VehicleTier.BICYCLE, VehicleName: '' }); });
